...
internal class ResponseClassifier : IResponseClassifier
{
    ...
    public bool retryUnexpectedRateLimitResponse;
    public int maximumNonRateLimitRetriesPerRequest;

    public ResponseClassifier(bool _retryUnexpectedRateLimitResponse, int _maximumNonRateLimitRetriesPerRequest = 3)
    {
        retryUnexpectedRateLimitResponse = _retryUnexpectedRateLimitResponse;
        maximumNonRateLimitRetriesPerRequest = _maximumNonRateLimitRetriesPerRequest;
    }
